...
l2.to_excel('results/1uwnoDarcyL2.xlsx')
...
for value in range(y_test.shape[0]):
    if value % 26 == 1:
        ...
        plt.margins(0)
        index = index + 1
# plt.savefig( 'figures/1EX_2_1.pdf')
plt.show()
...
"""
torch.save(model, 'model/1UWNO_darcy')
scipy.io.savemat('results/1uwno_results_darcy.mat', mdict={'x_test': x_test.cpu().numpy(),
