...
l2.to_excel('results/uwnoBurgersTimeDependentL2.xlsx')
...
plt.xlabel(r'$t$', size=12)
plt.ylabel(r'$x$', size=12)
# plt.savefig( 'figure/EX_1_2_1.pdf')
...
# plt.savefig( 'figure/EX_1_2_2.pdf')
plt.show()

# %%
""" For saving the trained model and prediction data """

torch.save(model, 'model/UWNO_burgers_time_dependent')
scipy.io.savemat('results/uwno_results_burgers_time_dependent.mat', mdict={'x_test': x_test.cpu().numpy(),
